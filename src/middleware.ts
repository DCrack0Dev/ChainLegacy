...
const STRICT_CSP_DIRECTIVES = [
  ...
  "form-action 'self'",
  "connect-src 'self' https://*.firebaseio.com https://firestore.googleapis.com https://www.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://api.ipify.org https://cloudflareinsights.com https://*.walletconnect.com https://pulse.walletconnect.org https://api.web3modal.org wss://relay.walletconnect.com https://api.coinbase.com https://metamask-sdk.api.cx.metamask.io https://rpc.walletconnect.com",
...
function buildCspHeader(): string {
  const scriptSrc = ["script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' https:"];
